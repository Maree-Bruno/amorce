<x-modals.modal>
    ...
    @if(session()->has('message'))
        <div class="absolute flex items-center justify-between max-w-3xl bg-green-500 rounded dissolve">
            <div class="flex items-center">
                ...
                <div class="py-4 text-white text-sm font-medium">{{ session('message') }}</div>
            </div>
